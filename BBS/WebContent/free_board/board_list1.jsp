...
<%@ page import="free_model1.BoardListTO" %>
...
<%
	...
	for(int i=0 ; i<boardLists.size() ; i++) {
		...
		html.append("		<a href='./free_view.do?seq=" + seq + "'>" + subject + "</a>&nbsp;");
		if(wgap == 0) {
...
<div id="board" class="container">
	...
	<div class="align_right">
		...
		onclick="location.href='./free_write.do'">쓰기</button>
	</div>
</div>
	...
	<div class="board_pagetab" align="absmiddle">
		<%
			...
			if(startBlock == 1) {
				...
				out.println("<span style='color: white;' class='on'><a style='color: white;' href='./free_list.do?cpage=" + (startBlock - blockPerPage) + "'>&lt;&lt;</a></span>");
			}
		%>			
						&nbsp;
		<%
			if(cpage == 1) {
				...
				out.println("<span style='color: white;' class='on'><a style='color: white;' href='./free_list.do?cpage=" + (cpage - 1) + "'>&lt;</a></span>");
			}
		%>				
						&nbsp;&nbsp;
		<%
			for(int i=startBlock ; i<=endBlock ; i++) {
				if(cpage == i) {
					...
					out.println("<span style='color: white;' class='on'><a style='color: white;' href='./free_list.do?cpage=" + i + "'>" + i + "</a></span>");
				}
			}	
		%>
						&nbsp;&nbsp;
