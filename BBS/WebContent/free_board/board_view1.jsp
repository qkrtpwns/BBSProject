		...
		<div class="contents_sub">
			...
			<div class="btn_area">
				...
				<div class="align_right">
					<button type="button" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./free_modify.do?seq=<%= seq %>'">수정</button>
					<button type="button" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./free_delete.do?seq=<%= seq %>'">삭제</button>
					<button type="button" class="btn_write btn_txt01" style="cursor: pointer;" onclick="location.href='./free_write.do'">쓰기</button>
				</div>
			</div>
			<!--//게시판-->
		</div>
