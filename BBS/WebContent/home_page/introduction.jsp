	...
	<nav class="navbar navbar-default">
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<li><a class="active" href="./introduction.do">게임소개</a></li>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="item active">
				...
				<div class="carousel-caption" style="border-style: solid; background-color: black;">
					<h2>탄탄한 스토리의 게임</h2>
					<p>비주얼 노벨 게임의 진수!</p>		
				</div>
			</div>
			...
			<div class="item">
				...
				<div class="carousel-caption" style="border-style: solid; background-color: black;">
					<h3>증거물을 모아 기사를 작성하라!</h3>
					<p>올바른 기사가 될 것인가? 당신의 선택에 달려있다.</p>		
				</div>
			</div>
		</div>
