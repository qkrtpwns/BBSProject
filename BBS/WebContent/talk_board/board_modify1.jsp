...
<div id="board" class="container">
	...
	<div class="con_txt">
		<form action="./talk_modify_ok.do" method="post" name="frm">
			...
			<div class="contents_sub">	
				...
				<div class="btn_area">
					<div class="align_left">
						...
						<button type="button" class="btn_list btn_txt02" style="cursor: pointer;" onclick="location.href='./talk_view.do?seq=<%= seq %>'">보기</button>
					</div>
